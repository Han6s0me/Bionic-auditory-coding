    ...
    for folder in os.listdir(dir):
        ...
        for file in file_path:
            ...
            if args.spec == 'cqt':
                ...
                # Engry = librosa.power_to_db(mel_spectrogram, ref=
            elif args.spec == 'mel2':
...
with open(savepath + 'summary_' + args.spec + '_' + args.net + '_' + 'freq.csv', mode='a', newline='') as file:
    summary = {
        'best_acc': 0,
        'best_loss': 0,
        'mode_path': 0,
...
for id in range(10):
    ...
    filename = savepath + 'Spec:' + args.spec + '_' + args.net + '_Max_num:%d' % Max_num + '_' + 'acc:%.4f' % \
               train_accuracy_all[
                   -1] + '_' + 'val_acc:%.4f' % \
