...
class SNNforauditory(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        return x
#%
modelname=findfile('/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R_MSE/LIF_Coding_Eng/T10_xiu/','.pth')
accuracyScore_ALL = []
...
for idx in range(len(modelname)):
    # modelpath='/home/handsome/PythonProject/SNN/snnmodel/Resultmodel_LIF_Encoding_RWCP/T20/Max_num:83_acc:1.0000_val_acc:1.0000_1699284528.pth'
    modelpath=modelname[idx]
    savepath='/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R_MSE/LIF_Coding_Eng/T10_xiu/'
