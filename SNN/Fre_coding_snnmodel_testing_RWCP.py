...
modelname=findfile('/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R_MSE/Freq_encoding/T10_1/','.pth')
accuracyScore_ALL = []
...
for idx in range(len(modelname)):
    ...
    savepath='/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R_MSE/Freq_encoding/T10_1/'
    # % 计算
