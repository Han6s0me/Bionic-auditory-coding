...
class SNNforauditory(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        return x
#%
modelname=findfile('/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R/Nobound_CQT_Coding_Eng_low/T10_1/','.pth')
...
for idx in range(len(modelname)):
    ...
    savepath='/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R/Nobound_CQT_Coding_Eng_low/T10_1/figure_T10/'
