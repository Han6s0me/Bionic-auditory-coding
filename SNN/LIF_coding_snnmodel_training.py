...
tau = 4.0
train_epoch = 200
# savepath='./snnmodel/Resultmodel_VAD_big_RWCP/Cochlea_Coding_Eng/T20/'
savepath = './LIF_Coding_Eng/T10_1/'
...
# savemat('/home/handsome/PythonProject/SNN/snnmodel/After_coding_data/LIF_coding/train_data_10T.mat', {'train_data': train_data})
# savemat('/home/handsome/PythonProject/SNN/snnmodel/After_coding_data/LIF_coding/label_data_10T.mat', {'train_labels': train_labels})
# #%%
# % 数据划分
from torch.utils.data import Dataset, DataLoader, TensorDataset
from sklearn.model_selection import train_test_split

with open(savepath + 'summary_' + args.spec + '_' + args.net + '_' + 'lif.csv', mode='a', newline='') as file:
    summary = {
        'best_acc': 0,
        'best_loss': 0,
        'mode_path': 0,
...
for id in range(10):
    ...
    filename = savepath + 'Spec:' + args.spec  + '_' + args.net+ '_Max_num:%d' % Max_num + '_' + 'acc:%.4f' % train_accuracy_all[
        -1] + '_' + 'val_acc:%.4f' % validation_accuracy_all[-1] + '_' + str(timestamp) + '_train_result.csv'
    ...
    modelfilename = savepath + 'Spec:' + args.spec + '_Max_num:%d' % Max_num + '_' + 'acc:%.4f' % train_accuracy_all[
