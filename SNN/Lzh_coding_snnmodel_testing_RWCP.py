...
class SNNforauditory(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        return x
#%
modelname=findfile('/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R_MSE/Lzh_Coding_Eng/T10/','.pth')
accuracyScore_ALL = []
...
for idx in range(len(modelname)):
    ...
    savepath='/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R_MSE/Lzh_Coding_Eng/T10/'
