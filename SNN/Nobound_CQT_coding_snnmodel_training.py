...
savepath = './Nobound_CQT_Coding_Eng_low/T10/'
...
# savemat('/home/handsome/PythonProject/SNN/snnmodel/After_coding_data/Nobound_cochlea_coding/train_data_10T.mat', {'train_data': train_data})
# savemat('/home/handsome/PythonProject/SNN/snnmodel/After_coding_data/Nobound_cochlea_coding/label_data_10T.mat', {'train_labels': train_labels})
# %%
# % 数据划分
...
with open(savepath + 'summary_' + args.spec + '_' + args.net + '_' + 'no_bound.csv', mode='a', newline='') as file:
    summary = {
        'best_acc': 0,
        'best_loss': 0,
        'mode_path': 0,
