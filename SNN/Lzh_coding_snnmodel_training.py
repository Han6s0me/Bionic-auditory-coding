...
# savemat('/home/handsome/PythonProject/SNN/snnmodel/After_coding_data/lzh_coding/train_data_10T.mat', {'train_data': train_data})
# savemat('/home/handsome/PythonProject/SNN/snnmodel/After_coding_data/lzh_coding/label_data_10T.mat', {'train_labels': train_labels})
# #%%

# #%% 保存数据
# from scipy.io import savemat
# savemat('/home/handsome/PythonProject/SNN/snnmodel/Model_TID_R/train_data_10T.mat', {'train_data': train_data})
# savemat('/home/handsome/PythonProject/SNN/snnmodel/Model_TID_R/label_data_10T.mat', {'train_labels': train_labels})
...
for id in range(10):
    ...
    if os.path.exists(savepath):
        ...
        print('ok I make it')
        os.makedirs(savepath)
    filename = savepath + 'Max_num:%d' % Max_num + '_' + args.net + '_' + 'acc:%.4f' % train_accuracy_all[-1] + '_' + 'val_acc:%.4f' % \
    ...
    modelfilename = savepath + 'Max_num:%d' % Max_num  + '_' + args.net + '_' + 'acc:%.4f' % train_accuracy_all[
