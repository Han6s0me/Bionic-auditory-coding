...
# sounddata,noicedata=add_noise(waveform,0)
# import math
...
#     return snr
# print(check_snr(sounddata,waveform))
...
def read_origindata(dir):  # 读取初始编码
    ...
    for folder in os.listdir(dir):
        ...
        for file in file_path:
            ...
            # sounddata=add_noise(sounddata,10)
...
# savemat('/home/handsome/PythonProject/SNN/snnmodel/After_coding_data/RWCP/Bioinspired_cochlea_coding/TEST/test_data_10T.mat', {'train_data': Test_data})
# savemat('/home/handsome/PythonProject/SNN/snnmodel/After_coding_data/RWCP/Bioinspired_cochlea_coding/TEST/labeltest_data_10T.mat', {'train_labels': test_labels})
# #%%
# % 构建网络
...
class SNNforauditory(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        return x
#%
modelname=findfile('/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R_MSE/Cochlea_Coding_Eng/T10_7/','.pth')
#%
accuracyScore_ALL = []
...
for idx in range(len(modelname)):
    ...
    savepath='/home/handsome/PythonProject/SNN/snnmodel/Model_RWCP_R_MSE/Cochlea_Coding_Eng/T10_7/'
...
# n_classes = np.unique(true_label).size
# y_true_binary = label_binarize(true_label, classes=range(n_classes))
# fpr = dict()
# tpr = dict()
# roc_auc = dict()
# for i in range(n_classes):
#     fpr[i], tpr[i], _ = roc_curve(y_true_binary[:, i], pred_probabilities[:, i])
