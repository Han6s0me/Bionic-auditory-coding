...
class SNNforauditory(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        return x
#%
modelname=findfile('/home/handsome/PythonProject/SNN/snnmodel/Model_TID_R_MSE/LIF_Coding_Eng/T10/','.pth')
...
for idx in range(len(modelname)):
    ...
    savepath='/home/handsome/PythonProject/SNN/snnmodel/Model_TID_R_MSE/LIF_Coding_Eng/T10/'
