1. Here we provided four spike encoding models including bioinspired auditory neuron (BAN), izhikevich (Izh), leaky integrate-and-fire (LIF), and poisson in Encoding_model folder, with a parameter for BAN model.  
